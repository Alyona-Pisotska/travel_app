...
export const getTrips = createAsyncThunk<any, any, { extra: { tripsService: Trips, notificationService: Notification } }>(
  ActionType.TRIPS,
  async (payload, { extra, rejectWithValue }) => {
    try {
      return { trips: await extra.tripsService.getTrips() };
    } catch (err: any) {
